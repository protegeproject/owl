/* Generated By:JavaCC: Do not edit this line. OWLCompactParser.java */
 ...
 */
public class OWLCompactParser implements OWLCompactParserConstants {
...
// or a slot name
        ...
        switch ((jj_ntk == -1) ? jj_ntk() : jj_ntk) {
            ...
            case XSD:
                ...
                if (index < token.image.length()) {
                    ...
                    {
                        if (true) return owlModel.getRDFSDatatypeByName(token.image);
                    }
                }
                break;
            case IDENTIFIER:
    ...
    private static void jj_la1_0() {
        jj_la1_0 = new int[]{0x83080000, 0x82080000, 0x78000000, 0x38000000, 0x83080000, 0x96000, 0x80000, 0x830e0000, 0x16000, 0x16000,};
    }


    private static void jj_la1_1() {
        jj_la1_1 = new int[]{0x0, 0x0, 0x6, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0,};
    }
    ...
    public OWLCompactParser(java.io.InputStream stream) {
        jj_input_stream = new JavaCharStream(stream, 1, 1);
        token_source = new OWLCompactParserTokenManager(jj_input_stream);
        token = new Token();
        jj_ntk = -1;
        jj_gen = 0;
        for (int i = 0; i < 10; i++)
    ...
    public OWLCompactParser(java.io.Reader stream) {
        jj_input_stream = new JavaCharStream(stream, 1, 1);
        token_source = new OWLCompactParserTokenManager(jj_input_stream);
        token = new Token();
        jj_ntk = -1;
