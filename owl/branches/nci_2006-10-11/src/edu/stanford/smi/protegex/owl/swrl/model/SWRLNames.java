...
/**
 * Defines the names of the SWRL system ontology classes and properties.
 * This corresponds to the Model interface in general Protege, and the
 * OWLNames interface in the OWL Plugin.
 *
...
public interface SWRLNames extends OWLNames {
    ...
    public final static String SWRL_IMPORT = "http://www.daml.org/rules/proposal/swrl.owl";

    public final static String SWRLB_IMPORT = "http://www.daml.org/rules/proposal/swrlb.owl";
