...
public interface OWLConversionFactory
{
  ...
  OWLDatatypeProperty getOWLDataProperty(String propertyURI) throws OWLConversionFactoryException;
  ...
  Set<OWLPropertyAssertionAxiom> getOWLPropertyAssertionAxioms(String individualURI, String propertyURI) throws OWLConversionFactoryException, DatatypeConversionException;
  Set<OWLPropertyAssertionAxiom> getOWLPropertyAssertionAxioms(String propertyURI) throws OWLConversionFactoryException, DatatypeConversionException;
