...
public class ClassTreeWithBrowserTextNode extends LazyTreeNode {
    ...
    protected Collection<FrameWithBrowserText> getChildObjects() {
        ...
        try {
            children = (Collection<FrameWithBrowserText>) 
                new GetChildObjectsJob(getCls().getKnowledgeBase(), getCls(), showHidden()).execute();            
        } catch (Throwable t) {
    ...
    private static class GetChildObjectsJob extends ProtegeJob {        
        ...
        public Object run() throws ProtegeException {
            ...
            if (showHidden) {
                clsChildren = new HashSet(cls.getDirectSubclasses());
            } else {             
                clsChildren = new HashSet(cls.getVisibleDirectSubclasses());
