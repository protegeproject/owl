...
public abstract class AbstractSWRLBuiltInLibrary implements SWRLBuiltInLibrary
{
	...
	public boolean invokeBuiltInMethod(Method method, SWRLBuiltInBridge bridge, String ruleName, String prefix, String builtInMethodName, int builtInIndex,
																			boolean isInConsequent, List<BuiltInArgument> arguments) throws BuiltInException
	{
		...
		synchronized (this) { // Only one built-in per library may be invoked simultaneously.
			invokingBridge = bridge;
			invokingRuleName = ruleName;
			invokingBuiltInIndex = builtInIndex;
			this.isInConsequent = isInConsequent;
			...
			try { // Invoke the built-in method.
				...
				if (targetException instanceof BuiltInException) { // A BuiltInException was thrown by the built-in.
					throw new BuiltInException("exception thrown by built-in " + builtInName + " in rule " + ruleName + ": " + targetException.getMessage(),
							targetException);
					...
					throw new BuiltInException("unknown exception thrown by built-in " + builtInName + " in rule " + ruleName + ": " + e.toString(), e);
			} catch (Throwable e) { // Should be one of IllegalAccessException or IllegalArgumentException
				throw new SWRLBuiltInLibraryException("internal built-in library exception when invoking built-in " + builtInName + " in rule " + ruleName + ": "
						+ e.getMessage(), e);
			} // try

			invokingBridge = null;
			invokingRuleName = "";
			invokingBuiltInIndex = -1;
	...
	public void checkNumberOfArgumentsAtLeastOne(List<BuiltInArgument> arguments) throws BuiltInException
	{
		if (arguments.size() < 1)
	...
	public void checkNumberOfArgumentsAtMost(int expectingAtMost, int actual) throws InvalidBuiltInArgumentNumberException
	{
	...
	public void checkNumberOfArgumentsInRange(int expectingAtLeast, int expectingAtMost, int actual) throws InvalidBuiltInArgumentNumberException
	{
	...
	{
		return (isArgumentNumeric(argumentNumber, arguments) && isArgumentAShort(argumentNumber, arguments) && isArgumentAnInteger(argumentNumber, arguments)
				&& isArgumentALong(argumentNumber, arguments) && isArgumentAFloat(argumentNumber, arguments));
	...
	{
		return (isArgumentNumeric(argumentNumber, arguments) && isArgumentAShort(argumentNumber, arguments) && isArgumentAnInteger(argumentNumber, arguments) && isArgumentALong(
	...
	{
		for (int argumentNumber = 0; argumentNumber < arguments.size(); argumentNumber++)
			if (isArgumentAnInteger(argumentNumber, arguments) || isArgumentALong(argumentNumber, arguments) || isArgumentAFloat(argumentNumber, arguments)
	...
	{
		for (int argumentNumber = 0; argumentNumber < arguments.size(); argumentNumber++)
			if (isArgumentALong(argumentNumber, arguments) || isArgumentAFloat(argumentNumber, arguments) || isArgumentADouble(argumentNumber, arguments))
				return false;
		return true;
	...
	{
		if (!isArgumentNumeric(argumentNumber, arguments))
			throw new InvalidBuiltInArgumentException(argumentNumber, makeInvalidArgumentTypeMessage(arguments.get(argumentNumber), "numeric"));
	...
	{
		if (!isArgumentOfAnOrderedType(argumentNumber, arguments))
			throw new InvalidBuiltInArgumentException(argumentNumber, makeInvalidArgumentTypeMessage(arguments.get(argumentNumber), "ordered type"));
	...
	public void checkThatArgumentIsADataValue(int argumentNumber, List<BuiltInArgument> arguments) throws BuiltInException
	{
		if (!isArgumentADatatypeValue(argumentNumber, arguments)) {
			throw new InvalidBuiltInArgumentException(argumentNumber, makeInvalidArgumentTypeMessage(arguments.get(argumentNumber), "data value"));
		} // if
	} // checkThatArgumentIsADataValue
	...
	public String getArgumentAsAURI(int argumentNumber, List<BuiltInArgument> arguments) throws BuiltInException
	{
		...
		if (isArgumentAClass(argumentNumber, arguments))
			uri = ((ClassArgument)arguments.get(argumentNumber)).getURI();
	...
	public void checkThatArgumentIsNonNumeric(int argumentNumber, List<BuiltInArgument> arguments) throws BuiltInException
	{
		if (!isArgumentNonNumeric(argumentNumber, arguments))
			throw new InvalidBuiltInArgumentException(argumentNumber, makeInvalidArgumentTypeMessage(arguments.get(argumentNumber), "non-numeric"));
	...
	{
		if (!isArgumentAnInteger(argumentNumber, arguments))
			throw new InvalidBuiltInArgumentException(argumentNumber, makeInvalidArgumentTypeMessage(arguments.get(argumentNumber), "integer"));
	...
	{
		if (isArgumentADataValue(argumentNumber, arguments))
			return (getArgumentAsADataValue(argumentNumber, arguments).isInteger());
		else
			return false;
	} // isArgumentAnInteger
	...
	public int getArgumentAsAPositiveInteger(int argumentNumber, List<BuiltInArgument> arguments) throws BuiltInException
	{
		...
		if (i < 0)
			throw new InvalidBuiltInArgumentException(argumentNumber, makeInvalidArgumentTypeMessage(arguments.get(argumentNumber), "expecting positive integer"));
		return i;
	...
	public void checkThatArgumentIsAProperty(int argumentNumber, List<BuiltInArgument> arguments) throws BuiltInException
	{
		if (!isArgumentAProperty(argumentNumber, arguments))
			throw new InvalidBuiltInArgumentException(argumentNumber, makeInvalidArgumentTypeMessage(arguments.get(argumentNumber), "property"));
	...
	public void checkThatArgumentIsAnObjectProperty(int argumentNumber, List<BuiltInArgument> arguments) throws BuiltInException
	{
		if (!isArgumentAnObjectProperty(argumentNumber, arguments))
			throw new InvalidBuiltInArgumentException(argumentNumber, makeInvalidArgumentTypeMessage(arguments.get(argumentNumber), "object property"));
	...
	public void checkThatArgumentIsADataProperty(int argumentNumber, List<BuiltInArgument> arguments) throws BuiltInException
	{
		if (!isArgumentADataProperty(argumentNumber, arguments))
			throw new InvalidBuiltInArgumentException(argumentNumber, makeInvalidArgumentTypeMessage(arguments.get(argumentNumber), "data property"));
	} // checkThatArgumentIsAProperty
	...
	public void checkThatArgumentIsAClassPropertyOrIndividual(int argumentNumber, List<BuiltInArgument> arguments) throws BuiltInException
	{
		if (!isArgumentAClassPropertyOrIndividual(argumentNumber, arguments))
			throw new InvalidBuiltInArgumentException(argumentNumber, makeInvalidArgumentTypeMessage(arguments.get(argumentNumber), "class, property, or individual"));
	...
	{
		return isArgumentAClass(argumentNumber, arguments) || isArgumentAProperty(argumentNumber, arguments) || isArgumentAnIndividual(argumentNumber, arguments);
	...
	{
		if (!isArgumentAClass(argumentNumber, arguments))
			throw new InvalidBuiltInArgumentException(argumentNumber, makeInvalidArgumentTypeMessage(arguments.get(argumentNumber), "class"));
	...
	{
		if (!isArgumentALong(argumentNumber, arguments))
			throw new InvalidBuiltInArgumentException(argumentNumber, makeInvalidArgumentTypeMessage(arguments.get(argumentNumber), "long"));
	...
	public long getArgumentAsAPositiveLong(int argumentNumber, List<BuiltInArgument> arguments) throws BuiltInException
	{
		...
		if (l < 0)
			throw new InvalidBuiltInArgumentException(argumentNumber, makeInvalidArgumentTypeMessage(arguments.get(argumentNumber), "expecting positive long"));
	...
	{
		if (!isArgumentAFloat(argumentNumber, arguments))
			throw new InvalidBuiltInArgumentException(argumentNumber, makeInvalidArgumentTypeMessage(arguments.get(argumentNumber), "float"));
	...
	{
		if (!isArgumentADouble(argumentNumber, arguments))
			throw new InvalidBuiltInArgumentException(argumentNumber, makeInvalidArgumentTypeMessage(arguments.get(argumentNumber), "double"));
	...
	{
		if (!isArgumentABoolean(argumentNumber, arguments))
			throw new InvalidBuiltInArgumentException(argumentNumber, makeInvalidArgumentTypeMessage(arguments.get(argumentNumber), "boolean"));
	...
	{
		if (!isArgumentAString(argumentNumber, arguments))
			throw new InvalidBuiltInArgumentException(argumentNumber, makeInvalidArgumentTypeMessage(arguments.get(argumentNumber), "string"));
	...
	public int getFirstUnboundArgument(List<BuiltInArgument> arguments) throws BuiltInException
	{
		for (int index = 0; index < arguments.size(); index++)
			if (arguments.get(index).isUnbound())
				return index;
	...
	{
		checkForUnboundArguments(arguments, "built-in does not support variable binding - unbound argument '" + getFirstUnboundArgument(arguments) + "'");
	...
	private String makeInvalidArgumentTypeMessage(BuiltInArgument argument, String expectedTypeName) throws BuiltInException
	{
		...
		if (argument.isUnbound())
			message += "unbound argument with variable name '" + argument.getVariableName() + "'";
		else {
	...
	public Object getArgumentAsAPropertyValue(int argumentNumber, List<BuiltInArgument> arguments) throws BuiltInException
	{
		...
		if (argument instanceof ClassArgument) {
			...
			if (dataValue.isNumeric())
				...
				result = dataValue.getString();
			else
				throw new BuiltInException("data value with value " + dataValue.toString() + " not supported - strings and number data values only");
		} else
	 ...
	 */
	public String createInvocationPattern(SWRLBuiltInBridge invokingBridge, String invokingRuleName, int invokingBuiltInIndex, boolean isInConsequent,
																				List<BuiltInArgument> arguments) throws BuiltInException
	{
		...
		if (invocationPatternMap.containsKey(pattern))
			result = invocationPatternMap.get(pattern).toString();
		else {
	...
	public void checkForUnboundArguments(String ruleName, String builtInName, List<BuiltInArgument> arguments) throws BuiltInException
	{
		for (BuiltInArgument argument : arguments) {
			if (argument.isUnbound())
				throw new BuiltInException("built-in " + builtInName + " in rule " + ruleName + " " + "returned with unbound argument ?" + argument.getVariableName());
			else if (argument instanceof MultiArgument && ((MultiArgument)argument).hasNoArguments())
				throw new BuiltInException("built-in " + builtInName + " in rule " + ruleName + " " + "returned with empty multi-argument ?"
			...
			throws BuiltInException
	{
		...
		if (isUnboundArgument(resultArgumentNumber, arguments)) {
			...
			for (BuiltInArgument argument : resultArguments)
	...
	public boolean processResultArgument(List<BuiltInArgument> arguments, int resultArgumentNumber, BuiltInArgument resultArgument) throws BuiltInException
	{
		boolean result = false;
	...
	public boolean processResultArgument(List<BuiltInArgument> arguments, int resultArgumentNumber, SWRLLiteralArgument resultArgument) throws BuiltInException
	{
		...
		if (isUnboundArgument(resultArgumentNumber, arguments)) {
			...
			result = dataValue.equals(resultArgument.getLiteral());
		} // if

		return result;
	}

	public boolean processResultArgument(List<BuiltInArgument> arguments, int resultArgumentNumber, short resultArgument) throws BuiltInException
	{
		return processResultArgument(arguments, resultArgumentNumber, argumentFactory.createDataValueArgument(resultArgument));
	}

	public boolean processResultArgument(List<BuiltInArgument> arguments, int resultArgumentNumber, int resultArgument) throws BuiltInException
	{
		return processResultArgument(arguments, resultArgumentNumber, argumentFactory.createDataValueArgument(resultArgument));
	}
	...
	public boolean processResultArgument(List<BuiltInArgument> arguments, int resultArgumentNumber, double resultArgument) throws BuiltInException
	{
		return processResultArgument(arguments, resultArgumentNumber, argumentFactory.createDataValueArgument(resultArgument));
	}

	public boolean processResultArgument(List<BuiltInArgument> arguments, int resultArgumentNumber, byte resultArgument) throws BuiltInException
	{
		return processResultArgument(arguments, resultArgumentNumber, argumentFactory.createDataValueArgument(resultArgument));
	}

	public boolean processResultArgument(List<BuiltInArgument> arguments, int resultArgumentNumber, String resultArgument) throws BuiltInException
	{
		return processResultArgument(arguments, resultArgumentNumber, argumentFactory.createDataValueArgument(resultArgument));
	}
	...
	{
		return argumentFactory.createObjectPropertyArgument(propertyURI);
	}
	...
	{
		return argumentFactory.createMultiArgument();
	}

	public MultiArgument createMultiArgument(List<BuiltInArgument> arguments)
	{
		return argumentFactory.createMultiArgument(arguments);
	}

	public CollectionArgument createCollectionArgument(String collectionName, String collectionGroupID)
	{
		return argumentFactory.createCollectionArgument(collectionName, collectionGroupID);
	}
}
