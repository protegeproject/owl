      ...
      case OPENSQPAR:
        ...
        case OPENPAR:
          token = jj_consume_token(OPENPAR);
                             minProp = owlModel.getRDFProperty(XSPNames.MIN_EXCLUSIVE);
          break;
        case OPENSQPAR:
          token = jj_consume_token(OPENSQPAR);
                               minProp=owlModel.getRDFProperty(XSPNames.MIN_INCLUSIVE);
          break;
        default:
          jj_la1[7] = jj_gen;
          jj_consume_token(-1);
        ...
        case CLOSEPAR:
          token = jj_consume_token(CLOSEPAR);
                              maxProp=owlModel.getRDFProperty(XSPNames.MAX_EXCLUSIVE);
          break;
        case CLOSESQPAR:
          token = jj_consume_token(CLOSESQPAR);
                                maxProp=owlModel.getRDFProperty(XSPNames.MAX_INCLUSIVE);
          break;
        default:
          jj_la1[12] = jj_gen;
          jj_consume_token(-1);
        ...
        ;
                ...
                if(userDerived == false) {
                        ...
                        if(create) {
                                ...
                                udd.setPropertyValue(owlModel.getRDFProperty(XSPNames.BASE), datatype);
